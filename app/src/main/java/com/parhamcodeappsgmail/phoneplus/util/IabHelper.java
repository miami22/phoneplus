 ...
 * the object on an DaggerActivity's onCreate method, then the recommended
 * place to dispose of it is the DaggerActivity's onDestroy method.
 *
...
public class IabHelper {
   ...
   *
   * @param ctx Your application or DaggerActivity context. Needed to bind to the in-app billing service.
   ...
   * MUST be called from the UI thread of the DaggerActivity.
   *
   ...
   * DaggerActivity's {@link Activity@onActivityResult} method. This method
   * MUST be called from the UI thread of the DaggerActivity.
   *
