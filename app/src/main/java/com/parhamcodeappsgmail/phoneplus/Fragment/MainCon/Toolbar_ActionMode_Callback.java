...
public class Toolbar_ActionMode_Callback implements ActionMode.Callback {
    ...
    private recycleAdaptermain recyclerView_adapter;
    //private rec listView_adapter;
    private List<itema> message_models;
    private boolean isListViewFragment;
    private LinearLayout checkkk,delet,share;
    public static TextView menutxt;
    private ImageView checkimage;
    private Boolean checkall=false;


    public Toolbar_ActionMode_Callback(Context context, recycleAdaptermain recyclerView_adapter,  List<itema> message_models, boolean isListViewFragment) {
    ...
    public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
            ...
            public void onClick(View view) {
                ...
                if (!checkall){
                    ...
                    if (recyclerFragment != null){
                        ...
                        ((mainconfrag) recyclerFragment).selectall();
                    ...
                    if (recyclerFragment != null)((mainconfrag) recyclerFragment).deselectall();
                    checkall=false;
        ...
        menutxt=checkkk.findViewById(R.id.counttxt);
        ...
        delet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (recyclerFragment != null)
                    //If recycler fragment not null
                    ((mainconfrag) recyclerFragment).deleteRows();//delete selected rows
                mode.finish();//Finish action mode
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (recyclerFragment != null)
                    //If recycler fragment not null
                    ((mainconfrag) recyclerFragment).sharecontact("p");//delete selected rows
                mode.finish();//Finish action mode
            }
        });
    ...
    public void onDestroyActionMode(ActionMode mode) {
        ...
        if (isListViewFragment) {
           ...
           // Fragment recyclerFragment = new MainActivity().getFragment(0);//Get recycler fragment
            Fragment recyclerFragment=flist.getFraga();
            if (recyclerFragment != null)
                ((mainconfrag) recyclerFragment).setNullToActionMode();//Set action mode null
        }
    }
