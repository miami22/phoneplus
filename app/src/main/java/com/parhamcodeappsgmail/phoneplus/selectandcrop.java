...
public class selectandcrop extends AppCompatActivity {
    private static final String TAG = selectandcrop.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selectandcrop);
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(context, android.app.AlertDialog.THEME_DEVICE_DEFAULT_DARK);
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(selectandcrop.this, getPackageName() + ".provider", image);
    }
